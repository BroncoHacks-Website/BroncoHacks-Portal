...
def run_db():
    ...
    try:
        ...
        cur.execute("INSERT INTO hackers (teamID, firstName, lastName, password, email, school, discord, confirmationNumber, isConfirmed, isAdmin) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                    (222222, 'Habibi', 'Mark', hash_password('1'), 'hmark@cpp.edu', 'cpp','habibimark', 666420, True, False ))
        cur.execute("INSERT INTO hackers (teamID, firstName, lastName, password, email, school, discord, confirmationNumber, isConfirmed, isAdmin) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                    (333333, 'Chris J', 'Lo', hash_password('1'), 'cjlo@cpp.edu', 'cpp','randompotato', 666420, True, False ))
        cur.execute("INSERT INTO hackers (teamID, firstName, lastName, password, email, school, discord, confirmationNumber, isConfirmed, isAdmin) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                    (222222, 'RealCaleb', 'C', hash_password('1'), 'kaichun24@gmail.com', 'cpp','tigga', 666420, True, False ))
        cur.execute("INSERT INTO hackers (teamID, firstName, lastName, password, email, school, discord, confirmationNumber, isConfirmed, isAdmin) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                    (222222, 'RealCale', 'C', hash_password('1'), 'ckchung@cpp.edu', 'cpp','tiggar', 666420, True, False ))
