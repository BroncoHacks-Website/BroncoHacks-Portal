    ...
    <>
      {visibility && (
        <div className="z-10 flex items-center mx-auto left-1/4 transform -translate-x-1/6 top-6 p-4 mb-4 text-md text-blue-800 border border-blue-300 rounded-lg bg-blue-50">
          ...
          <div className="mr-2">
            <span className=""></span> You must have a team of at least 2
            members to register. If you do not have a preformed team, you can
            fill{" "}
            <a
              href="https://docs.google.com/forms/d/e/1FAIpQLScEzsWew9cDBWoENUKWM_dbxpJR-F18RTxr43qXwaNpkACS2w/viewform"
              className="font-semibold underline hover:no-underline"
            >
              this form
            </a>{" "}
            where we will find you a team!
          </div>
          <button
            type="button"
