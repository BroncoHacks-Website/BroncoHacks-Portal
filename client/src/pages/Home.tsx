      ...
      <div className="relative h-[85vh] flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row h-[70vh] w-[100vw] justify-center items-center m-auto">
          <img
            ...
            className="h-[30vh] w-[30vh] mx-auto animate-[float_3s_infinite_alternate] shadow-2xl rounded-full"
          ...
          <div className="w-[65vw]">
            ...
            <div className="flex flex-col sm:flex-row justify-items:start ">
              ...
              <Link
                className="mx-auto text-white text-[1.5rem] md:text-[1.7rem] shadow-2xl bg-[#035BA5] anmat-th-bttn-gng focus:outline-none focus:ring-2 focus:ring-green-300  rounded-[20px] py-3 px-4 md:py-4 md:px-8 transform hover:scale-105"
                to={{ pathname: "/Login" }}
              >
                Login 🐎
              </Link>
